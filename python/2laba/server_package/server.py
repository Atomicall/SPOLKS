...
class Server:
    ...
    def _init_sockets(self):
        ...
        print(
            f'TCP Server created on address: {ip.get_local_ip_address(is_local_host=IS_LOCAL_HOST)}:{self.TCP_PORT}')
        self._set_udp_socket()
        print(
            f'UDP Server created on address: {ip.get_local_ip_address(is_local_host=IS_LOCAL_HOST)}:{self.UDP_PORT}')
